...
import { FiNavigation, FiSearch, FiAlertCircle, FiRefreshCw, FiX } from 'react-icons/fi';
...
const LiveAQIPage = () => {
  const { userData, aqiData: healthAqiData, reportData, showReport } = useHealthReport();
  ...
  return (
    <div className="pt-20 pb-16">
      <div className="container-custom">
        ...
        {showReport && userData && healthAqiData && reportData && (
          <motion.div 
            className="mt-8"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
          >
            <div className="p-4 border rounded-lg shadow-sm bg-white dark:bg-dark-800 border-gray-200 dark:border-dark-700">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Your Health Report</h2>
                <button 
                  onClick={() => setShowReport(false)} 
                  className="p-2 text-gray-500 transition-colors rounded-full hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700"
                >
